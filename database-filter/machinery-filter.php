				...
				<div class="wrap-cont">
					<div class="select-wrap">
						<select  name="divisions" id="divisions" class="selectpicker" title="Division" data-width="100%" data-dropup-auto="false">
							...
							<option class="ddagriculture"value="agriculture" >Agriculture</option>
                            <option value="dairy" class="dddairy">Dairy</option>
                            <option value="construction" class="ddconstruction">Construction</option>
							<option value="groundcare" class="ddgroundcare">Groundcare</option>
						</select>	
					</div>
				</div>
			</div>					
				...
				<div class="wrap-cont">
					<div class="select-wrap">
						<select name="machinerytype" id="machinerytype" multiple class="selectpicker" title="Machinery Type  &nbsp; (Multiple Select)" data-width="100%" data-dropup-auto="false">
							...
							<?php
							$categories = get_categories(  array('hide_empty' => 1, 'parent' => 0));
						...
						<select name="year" id="year" class="selectpicker" title="Year" data-width="100%" data-dropup-auto="false">
							...
							<?php
								...
								foreach( $years as $year ) {
									...
									echo'<option value="'.$year->meta_value.'" >From '.$year->meta_value.'</option>';
									}
								}
